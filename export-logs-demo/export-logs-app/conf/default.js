...
module.exports = {
	...
	// API key
	apikey: 'tIDSz4eaxCdt3BBpSQGvBIW+ntHobfFg',
	...
	logLevel: 'trace', // Log level of the main logger.
	...
	session: {
		...
		encryptionKey: 'HSuB9g+6rDQT+wgFFY+Xa9GPWADjCGOYbXR1oaaZ8cQ=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: '29uTlzu03MqOukpZ9jqbNG7UW/JlH/MBo0QdDsLGTBhwtZglvHWNjtaNyOKvBVvhXiwfYEeDGJgGBz8yoTl+cQ==',
		secret: 'BF+genkas0uoh/BMzMlvWQfKLmK5MeJ9', // should be a large unguessable string
	...
	cookieSecret: 'QXJcRhcPB4JEh95coTXG7DakRRbGhz/i',
