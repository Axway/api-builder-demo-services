...
const shortName = connectorName.startsWith('@') ? connectorName.substring(connectorName.indexOf('/') + 1) : connectorName
...
test('### Test SDK functions - Error Response ###', t => {
  ...
  const connectorConfig = require(path.join(configFolderPath, `${shortName}.default.js`)).connectors[shortName]
