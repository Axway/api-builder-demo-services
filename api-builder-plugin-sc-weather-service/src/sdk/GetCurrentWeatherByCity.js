const connectorConfig = require('../../config/api-builder-plugin-sc-weather-service.default.js')
const endpointMetadata = require('../../config/sdk')['GetCurrentWeatherByCity']
...
module.exports = (makeRequest) => {
  return (requestData, callback, config) => {
    const runtimeConfig = config || connectorConfig.connectors['api-builder-plugin-sc-weather-service']
    makeRequest(
