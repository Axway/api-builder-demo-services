...
module.exports = {
	...
	// API key
	apikey: 's/8s2NjkihZoDgqnPfSayds/HhUSPdrQ',
	...
	session: {
		...
		encryptionKey: 'aoI6PDrEx2sd36KS3E85KBFNxldmAlgaezh8+ilhNl4=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: '8mJrq/tZRgS3q0sFei89flfisSjwslLxlRvjk9neffD5zMuxBxbbeSiyKDTsWaYL4qTZNj46YeJwgsgh23zNQA==',
		secret: 'Nec+j2z8GFhzUCpW73pTJDZeZPdJ5e3/', // should be a large unguessable string
