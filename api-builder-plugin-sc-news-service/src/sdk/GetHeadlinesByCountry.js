const connectorConfig = require('../../config/api-builder-plugin-sc-news-service.default.js')
const endpointMetadata = require('../../config/sdk')['GetHeadlinesByCountry']
...
module.exports = (makeRequest) => {
  return (requestData, callback, config) => {
    const runtimeConfig = config || connectorConfig.connectors['api-builder-plugin-sc-news-service']
    makeRequest(
