...
Once your project is running, you can point your browser at http://localhost:8080/console to access the API Builder user interface (UI) console.
[You can read the official documentation of how to further use the API Builder UI.](https://docs.axway.com/bundle/API_Builder_4x_allOS_en/page/api_builder_getting_started_guide.html)
...
API Builder Apps comes with a Dockerfile. When we generate service with API Builder CLI we get an app that has Dockerfile in its root.
